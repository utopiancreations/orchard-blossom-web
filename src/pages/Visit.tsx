            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-700 mb-1 flex items-center">
                  ...
                  <span><a href="tel:+12094830048" className="hover:text-ranch-accent">(209) 483-0048</a> or <a href="tel:+19163371738" className="hover:text-ranch-accent">(916) 337-1738</a></span>
                </p>
